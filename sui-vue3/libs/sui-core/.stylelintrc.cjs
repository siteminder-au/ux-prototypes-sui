module.exports = {
  ...
  rules: {
    ...
    // Anything that changes the specificity or selectors can introduce breaking changes within libs and between related libraries
    ...
    'selector-pseudo-class-no-unknown': [true, {
      severity: 'warning',
      ignorePseudoClasses: ['slotted', 'deep'] // :slotted() and :deep() selectors in Vue3 https://vuejs.org/api/sfc-css-features.html#slotted-selectors
    }],
